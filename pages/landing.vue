  ...
  <div :class="darkMode() ? 'darkBG' : 'lightBG'">
    ...
    <div class="main">
      ...
      <vue-typed-js
        ...
        :showCursor="false"
        :loop="true"
        :strings="[greetings() + ', ' + nicknames + '! ^5000', 'Haloo Dariinn, jangan insecure lagi yaa☺️ ^2500', 'Aku berharap kau selalu bahagia ^2500', 'Dan aku pun slalu bangga dengan hal apapun yang membuat mu senang ^2500', 'Tetap semangat disekolah dan semoga sekolahmu juga menyenangkan ^2500', 'ily ^2500'
'aku bangga mengenalmu😊 ^2500' ]"
        :backDelay="300"
        :typeSpeed="100"
        :backSpeed="20"
        :contentType="'null'"
